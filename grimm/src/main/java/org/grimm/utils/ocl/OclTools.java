...
import org.grimm.utils.ocl.exceptions.VariableNotFoundException;

public class OclTools {

	/**
	 * Recupere l'arbre syntaxique correspondant au fichier OCL fournit.
	 ...
	 * @param node Noeud de type {@link PathNameCS} a analyser
	 * @return <code>String</code> contenant le chemin spacifia dans le noeud
	 */
	...
	/**
	 * Recupere la liste de toutes les variables specifiees dans un noeud et ses fils.
	 * @param node Noeud a parcourir a la recherche de variables
	 * @return Liste des variables presentes dans le noeud et ses fils
	 */
